...
\work {
	...
	\italian{
	\section{\summary}
        Il mio principale campo di lavoro \`e lo sviluppo di web applications e
        ...
        di realizzare servizi a supporto degli IVR di Vodafone
        e di curare lo sviluppo di diverse App,
        ...
        Per tutta la durata delle mie collaborazioni, sia al Politecnico di Torino, sia ad Ennova,4

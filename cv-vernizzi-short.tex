...
I~am currently a senior software developer at Ennova Srl,
  ...
  % Inizio: 01/11/2011
  \cventry{\textbf{since 2011}}{Senior Software Developer}{Ennova Srl, \url{http://www.ennova.it/}}{}{}{%
  \justify
...
\section{\skills}
    ...
    \cvcomputer{Programming}{\justify PHP/Yii framework, MySql, Javascript, Ruby/Rails, HTML, CSS/Bootstrap, C, Java, Python} {OS}{Linux, Mac OS X, Windows} 

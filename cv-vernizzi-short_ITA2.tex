...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
$	\vspace{-3.0em}  %%% Hack to fit in 2 pages
\justify
...
Lavoro come senior software developer presso Ennova Srl, una startup del Politecnico
di Torino che realizza soluzioni
...
Prima di occuparmi di web e mobile application,
      ...
      In questo contesto, ho iniziato ad occuparmi di \emph{trusted computing}
      grazie alla partecipazione al progetto europeo \otc, il cui scopo era
      di sviluppare un framework open source che sfruttasse le potenzialit\`a di questa tecnologia.
...
Per tutta la durata delle mie collaborazioni, sia al Politecnico di Torino, sia ad Ennova,
  ...
  % Inizio: 01/11/2011
  \cventry{\textbf{Dal 2011}}{Senior software developer e project manager}{Ennova s.r.l, \mbox{\url{http://www.ennova.it/}}}{}{}{%
  \justify
  Mi occupo di mantenere i contatti con i clienti, progettare le soluzioni e scrivere parte del codice.
  Lo sviluppo consiste principalmente nell'integrazione dei database dei clienti, nello sviluppo
  ...
  Inoltre, mi occupo di progettare, costruire e mantenere aggiornata
...
Ho partecipato a TClouds, un progetto di ricerca finanziato dalla comunit\`a europea
...
Durante il dottorato ho studiato la possibilit\`a di utilizzare la tecnologia del \emph{trusted computing} per migliorare
la sicurezza delle reti di calcolatori. Ho svolto la maggiorparte dell'attivit\`a di ricerca partecipando al progetto
di ricerca europeo \otc, svolto in collaborazione con IBM, HP, AMD e diverse universit\`a europee.
Lo scopo del progetto era quello di sviluppare un framework open source in grado di sfruttare le potenzialit\`a
del trusted computing ed applicarle a casi reali. All'interno del progetto mi sono occupato principalmente di
studiare come utilizzare il \emph{TPM} per migliorare la sicurezza dei dati memorizzati e di quelli scambiati in rete.
Il risultato principale delle mie ricerche \`e il \emph{trusted channel}, un protocollo crittografico basato su TLS
in grado di garantire il comportamento degli endpoint coinvolti nella comunicazione di rete.
Questo protocollo \`e descritto in diversi articoli scientifici e ne \`e disponibile un'implementazione
basata su OpenSSL.
%In particolare mi sono sono concentrato sull'handshake del protocollo TLS al fine di aumentare la
%\emph{fiducia} reciproca tra gli endpoint della comunicazione. Il canale risultante 
%In particolare ho proposto di utilizzare le estensioni standard del protocollo TLS per integrare all'interno dell'handshake TLS
}
...
\cventry{\textbf{dal 2003}}{Consulenze ed attivit\`a didattica}{}{}{}{%
  \justify
...
Ho lavorato come consulente in diversi progetti, spaziando tra sicurezza informatica, sviluppo di librerie crittografiche e web application.
Inoltre ho insegnato al Politecnico di Torino come assistente ed in varie aziende in qualit\`a di formatore.
}
...
%            Advisor: Prof. Antonio Lioy.
	\cventry{15 aprile 2010}{Dottorato in Ingegneria Informatica e dei Sistemi}{Politecnico di Torino}{}{}{%{XXII Ciclo}{}{%
	...
	\cventry{5 maggio 2006}{Laurea Specialistica in Ingegneria Informatica}{Politecnico di Torino}{}
		{}{%
		%{\textit{104/110}}{%
	...
	\cventry{11 luglio 2005}{Dipl\^ome d'Ing\'enieur
...
\section{\skills}
    ...
    \cvcomputer{Programmazione}{\justify PHP/Yii framework, MySql, Javascript, Ruby/Rails, HTML, CSS/Boostrap, C, Java, Python}
               {Altro}{\justify Amazon Web Services, \mbox{sicurezza} \mbox{informatica} e \mbox{crittografia}, Linux e OsX, vim, \LaTeX, office}{}{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\misc}
    \cvline{\textbf{Lingue}}{Madrelingua italiano. Fluente in inglese e francese.}
%    \cvline{\textbf{Teaching}}{Teaching at Politecnico di Torino as teacher assistant and teaching to private companies.}
    \cvline{\textbf{Interessi}}{Lettura, fotografia, viaggi.}

...
Per tutta la durata delle mie collaborazioni, sia al Politecnico di Torino, sia ad Ennova,
  ...
  % Inizio: 01/11/2011
  \cventry{\textbf{Dal 2011}}{Sviluppatore \emph{full stack} e project manager}{Ennova s.r.l, \mbox{\url{http://www.ennova.it/}}}{}{}{%
  \justify
  ...
  Inoltre, mi sono anche occupato di progettare e costrure
...
\section{\skills}
    ...
    \cvcomputer{Programmazione}{\justify PHP, MySql, Javascript, HTML, CSS, C, Java, Python} {OS}{Linux, Mac OS X, Windows} 
    \cvcomputer{Altro}{\justify Amazon Web Services, sicurezza informatica e crittografia, UML, vim, \LaTeX, office}{}{}

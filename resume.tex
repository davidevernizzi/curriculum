...
\vspace{-1em}
  ...
  \item To better handle the development process of this application, we have created a custom continuous integration/continuous workflow.
  ...
  The tool is now used by 4 QA engineers on daily basis and has been employed to run more than 600K test scenarios

...
\vspace{-1em}
  ...
  This porting, which required to split the legacy code into microservices written in Clojure
  ...
  continuous integration/continuous deploy workflow. This flow is now composed of more than 15 JenkinsCI jobs and requires
  ...
  Moreover, I am currently taking care of the maintenance of 13 production servers and 5 QA servers.
  ...
  \item Designed and written an internal tool that streamlined the QA operation of the company.
  The tool is now used by 4 QA engineers on daily basis and has been employed to run more than XXX test scenarios
